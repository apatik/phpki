<form action='{$PHP_SELF}' method=post>
    ...
    <input type=hidden name=comment_root value="{$comment_root}">
    <input type=hidden name=comment_email value="{$comment_email}">
    <input type=hidden name=comment_sign value="{$comment_sign}">
    <input type=hidden name=comment_srv value="{$comment_srv}">
    <input type=hidden name=comment_stamp value="{$comment_stamp}">
