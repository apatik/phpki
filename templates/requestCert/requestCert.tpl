...
<form action="{$PHP_SELF}" method=post name=request>
    <table width='99%'>
        ...
        <tr>
            ...
            <td><select name=cert_type onchange={literal}"if (this.value=='server' || this.value=='client_server'){setVisibility('testrow1',true); setVisibility('testrow2',true);} else {setVisibility('testrow1',false); setVisibility('testrow2',false);}"{/literal}>
                    ...
                    <option value="client_server" {if $cert_type eq 'client_server'}selected='selected'{/if}>SSL Server + SSL Client</option>
